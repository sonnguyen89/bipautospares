...
<div class="logo"><a href="<?php echo get_option('home'); ?>" title="<?php bloginfo(); ?>"><img src="<?php bloginfo('template_directory')?>/images/logo.png" alt="<?php bloginfo(); ?>" title="<?php bloginfo(); ?>">
<div class="logotxt"><span>B.I.P</span> AUTO PARTS</div></a></div>
